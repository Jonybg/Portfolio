            ...
            <div className="max-w-[1000px] mx-auto p4 flex flex-col justify-center w-full h-full" >
                ...
                <div className="w-full  grid grid-cols-2 xl:grid-cols-6 sm:grid-cols-3 gap-4 text-center py-8 shadow-md shadow-[#19ddd6] " >
                    <div className=" hover:scale-110 duration-500" >
                        <img className="w-8 mx-auto" src={HTML} alt="" />
                        <p className="my-4" >HTML</p>
                    </div>
                    <div className=" hover:scale-110 duration-500" >

                        <img className="w-8 mx-auto" src={CSS} alt="" />
                        <p className="my-4" >CSS</p>
                    </div>
                    <div className=" hover:scale-110 duration-500" >
                        <img className="w-8 mx-auto" src={JS} alt="" />
                    ...
                    <div className=" hover:scale-110 duration-500" >
                        <img className="w-8 mx-auto" src={TAILWIND} alt="" />
                        <p className="my-4" >TAILWIND</p>
                    </div>
                    <div className=" hover:scale-110 duration-500" >
                        <img className="w-8 mx-auto" src={NODE} alt="" />
