export const Contact = () => {
    return (
        <div className="w-full h-screen bg-black flex justify-center items-center p-4" name="contact">
            <form className="flex flex-col w-[80%] sm:w-[50%]">
                <div className="pb-8 items-center flex flex-col xl:items-start">
                    ...
                    <p className="py-4 text-white">//so we can get to know each other better!<span className="text-[#19ddd6] text-2xl">.</span></p>
                </div>
